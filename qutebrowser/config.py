...
# Define the colors
COLOR_BASE00 = "#{{{ _color_base00_hex }}}" # Background
COLOR_BASE01 = "#{{{ _color_base01_hex }}}" # Lighter background
COLOR_BASE02 = "#{{{ _color_base02_hex }}}" # Selection background
COLOR_BASE03 = "#{{{ _color_base03_hex }}}" # Comments
COLOR_BASE04 = "#{{{ _color_base04_hex }}}" # Dark foreground
COLOR_BASE05 = "#{{{ _color_base05_hex }}}" # Default foreground
COLOR_BASE06 = "#{{{ _color_base06_hex }}}" # Light foreground
COLOR_BASE07 = "#{{{ _color_base07_hex }}}" # Light background
COLOR_BASE08 = "#{{{ _color_base08_hex }}}" # Red
COLOR_BASE09 = "#{{{ _color_base09_hex }}}" # Orange
COLOR_BASE0A = "#{{{ _color_base0A_hex }}}" # Yellow
COLOR_BASE0B = "#{{{ _color_base0B_hex }}}" # Green
COLOR_BASE0C = "#{{{ _color_base0C_hex }}}" # Cyan
COLOR_BASE0D = "#{{{ _color_base0D_hex }}}" # Blue
COLOR_BASE0E = "#{{{ _color_base0E_hex }}}" # Pink
COLOR_BASE0F = "#{{{ _color_base0F_hex }}}" # Extra color

# Define fonts
FONT_NAME = "{{{ _font_name }}}"
FONT_SIZE = "{{{ _font_size }}}pt"
...
START_PAGE = os.path.join(os.environ["XDG_CONFIG_HOME"],
...
c.fonts.completion.category = f'bold {FONT_SIZE} monospace'
c.fonts.completion.entry = f'{FONT_SIZE} monospace'
c.fonts.debug_console = f'{FONT_SIZE} monospace'
...
c.fonts.downloads = f'{FONT_SIZE} monospace'
c.fonts.hints = f'bold {FONT_SIZE} monospace'
c.fonts.keyhint = f'{FONT_SIZE} monospace'
c.fonts.messages.error = f'{FONT_SIZE} monospace'
c.fonts.messages.info = f'{FONT_SIZE} monospace'
c.fonts.messages.warning = f'{FONT_SIZE} monospace'
c.fonts.prompts = f'{FONT_SIZE} monospace'
c.fonts.statusbar = f'{FONT_SIZE} monospace'
c.fonts.tabs = f'{FONT_SIZE} monospace'
...
config.bind('xB', f'set statusbar.hide {c.statusbar.hide}')

# Tab creation
config.bind('<Ctrl-Shift-T>', 'open -t -r')

# Userscripts
config.bind(',ll', 'spawn --userscript lastpass {url}')
config.bind(',lp', 'spawn --userscript lastpass --password {url}')
config.bind(',lu', 'spawn --userscript lastpass --username {url}')
